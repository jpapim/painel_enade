...
INSERT INTO `email_acesso` VALUES (1,'administrador@gmail.com',1),(2,'alyssontkd@gmail.com',1),(3,'xxxx@gmail.com',1);
...
INSERT INTO `login` VALUES (1,'25d55ad283aa400af464c76d713c07ad',1,'2014-08-27 21:53:33','2014-08-27 21:53:37',1,1,1,1,'25d55ad283aa400af464c76d713c07ad'),(2,'25d55ad283aa400af464c76d713c07ad',1,'2014-08-27 21:53:33','2014-08-27 21:53:37',2,2,1,1,'25d55ad283aa400af464c76d713c07ad'),(3,'25d55ad283aa400af464c76d713c07ad',NULL,NULL,'2016-10-24 03:10:42',3,3,1,1,'');
...
CREATE TABLE `usuario` (
  ...
  CONSTRAINT `ix_usuarios_perfil` FOREIGN KEY (`id_perfil`) REFERENCES `perfil` (`id_perfil`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `usuario` VALUES (1,'Administrador ENADE',1,1,1,1,'Admin'),(2,'Alysson Vicu̱a de Oliveira',1,1,2,2,'Professor'),(3,'Secretaria',1,1,3,3,'Testador');
...
-- Dump completed on 2016-10-24  3:56:01
