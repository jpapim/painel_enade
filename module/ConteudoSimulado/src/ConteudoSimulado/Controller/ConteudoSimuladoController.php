...
namespace ConteudoSimulado\Controller;

use Estrutura\Controller\AbstractCrudController;
use Zend\View\Model\ViewModel;

class ConteudoSimuladoController extends AbstractCrudController
{
    /**
     * @var \ConteudoSimulado\Service\ConteudoSimulado
     */
    protected $service;

    /**
     * @var \ConteudoSimulado\Form\ConteudoSimulado
     */
    protected $form;
